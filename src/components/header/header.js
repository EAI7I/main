                ...
                <div className='mobile__header-title'>
                    <div className='mobile__header-title-name'>
                        <div className='mobile-logo'>
                            <NavLink to='/main' style={{cursor: 'pointer', outline: 'none'}}><img src="https://i.ibb.co/S0t0jVC/logo.png" alt='logo'/></NavLink>
                        </div>
                        <div></div>
                        <NavLink to='/main' style={{cursor: 'pointer', color: 'black', textDecoration: 'none', outline: 'none'}}><div className='mobile-name'>
