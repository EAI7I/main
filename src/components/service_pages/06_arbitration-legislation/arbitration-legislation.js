...
const ArbitrationLegislation = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Арбитражное законодательство</title>
                <meta name="description" content="Профессиональная юридическая помощь в Кемерово в области арбитражного законодательства." />
            </Helmet>
            <Header/>
